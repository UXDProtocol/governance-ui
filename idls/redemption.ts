export type Redemption = {
  ...
  "instructions": [
    ...
    },
    {
      ...
      "docs": [
        "Conversion of UXP to UCT (1 to 1 conversion)."
      ],
      "accounts": [
        {
          "name": "payer",
          ...
          "isSigner": true,
          "docs": [
            "#1 - Permissionless IX, can be called by anyone"
          ]
        },
        {
          "name": "user",
          ...
          "isSigner": true,
          "docs": [
            "#2 - Whoever is converting their token must sign"
          ]
        },
        {
          "name": "userUxp",
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          ...
          "isSigner": true,
          "docs": [
            "#2 - The redeeming user must sign"
          ]
        },
        {
          "name": "userUct",
    ...
    },
    {
      ...
      "docs": [
        "Deposits previously illiquid assets (USDC) into the vault."
      ],
      "accounts": [
        {
          "name": "payer",
